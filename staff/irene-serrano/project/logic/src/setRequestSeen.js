...
/**
 * Sets the property 'seen' true after see a developer profile the first time you visit it from a request
 * 
...
function setRequestSeen(companyId, offerId, requestId ){
    ...
    .then( res =>{
        ...
        const seenRequest = requests[requestIndex]

        seenRequest.seen = true
